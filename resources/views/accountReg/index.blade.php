	...
	<div id="content">
			<div class="container-fluid">
				<div class="row" style="padding:0px; background-color:#f8f8f8 ">
					<div class="col-md-6 col-lg-6 col-xs-12 col-sm-12" style="padding:6%; ">
						...
						<div class="col-md-10">
							...
							{!! Form::open(['action' => 'AccountRegister@store','method'=>'POST', 'class'=>'form-horizontal','id'=>'form_id']) !!}
							
								<div class="col-xs-12">
									@include('nav.messages')
									<p style="font-weight:bolder;text-align:center;">RECRUITER REGISTRATION</p>
								</div>
								...
								<div class="input-group image-preview">
									{{Form::text('cpassword','',['class'=>'form-control image-preview-filename','disabled'=>'disabled'])}}
									...
									<span class="input-group-btn">
										...
										<div class="btn btn-default image-preview-input">
											...
											<span class="image-preview-input-title">Upload CV</span>
								...
								<div class="form-group">
									<div class="col-xs-12" >
										<div class="checkbox checkbox-success" style="padding-left:21px">
